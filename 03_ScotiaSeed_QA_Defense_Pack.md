...
**Headline:** That's why the $25 is the *smallest* milestone. 92% of the $300 is gated on engagement that creates retention by itself.

**Backup math:**
- Bonus distribution: $25 instant + $25 education + $50 PAC (after 3 months) + $100 at month 12 + $100 at month 24.
- Only $25 is paid before behavior. $275 (92%) is paid after behavioral commitment.
- Vanguard research: 9 in 10 auto-enrolled retirement contributors still enrolled at 3 years. The PAC is the moat; the cash is the catalyst.
- **The $25 walk-away is also a feature, not a bug.** It builds Scotia's brand as "the bank that genuinely helps you start." Even a 50% drop-off rate at the $25 stage leaves the *converted* cohort highly profitable.
...
- 20-year compounding at modest 6% real returns: $5,500/yr × 20 yrs = $202K accumulated.
- Scotia revenue at typical 0.65% MER on $50K average lifetime AUM = $325/yr × 20 yrs (undiscounted) = $6,500. NPV at 7% = ~$3,500.
- Plus the cross-sell: FHSA → first mortgage → wealth advisory. The mortgage alone has $1,500+ in attach value.
- **Even if half our assumptions are wrong, we're still NPV-positive at 5x.**
...
- 8% pilot conversion = 100K accounts in year 1.
- Wealthsimple's organic cross-sell from Cash → Invest runs ~15–25% within 12 months (industry estimates).
...
- At 2.5¢ × 275 = $6.88/yr ≈ $14/2yr. Cap at $50 to handle high-volume spenders.
- The feature exists to anchor daily banking → investing identity. It's a brand investment, not a financial one.
- Wealthsimple Roundup proves the engagement effect: users with Roundup enabled retain at meaningfully higher rates than those without.
...
**Headline:** That's exactly why the bonus lands in chequing first. The user one-taps which account to sweep it into, after seeing the contribution-room implication.

**Backup detail:**
- 2026 TFSA contribution limit: $7,000.
- Bonus paid into TFSA = counts as contribution and reduces room (CRA-confirmed).
- ScotiaSeed deposits the bonus into chequing, then surfaces a destination chooser: TFSA (with room indicator), FHSA, or non-registered.
- This also creates a financial-literacy teachable moment: "Here's why TFSA room matters."

### Q8. "FCAC requires clear disclosure of promotional terms. How are you disclosing the forfeiture rule?"

**Headline:** Plain-language disclosure on the two-ledger dashboard itself, plus a dedicated transparency screen and pre-program email summary. FCAC's $10M penalty for misleading communication is a hard constraint we designed around.

**Backup detail:**
- FCAC's Financial Consumer Protection Framework requires advertisements to be "accurate, clear and not misleading" ([source](https://www.canada.ca/en/financial-consumer-agency/services/banking/rights-new-protections/consumer-protection-framework.html)).
- Forfeiture rule disclosed in 3 places: (1) signup terms, (2) the two-ledger UI showing locked vs liquid, (3) when the user *initiates* a withdrawal touching Scotia's portion, an in-the-flow warning.
- 90-day grace window to restore = clearly more consumer-friendly than industry-standard hard clawbacks.

### Q9. "Is the cash bonus considered a sales inducement under CIRO? Could it bias your advice?"

**Headline:** It's a consumer incentive paid by the institution to the customer, not by an advisor or vendor. CIRO's inducement rules target *vendor → advisor* or *product → advisor* commissions, not bank-funded customer promos.
...
**Headline:** Bank account opening bonuses are generally treated by CRA as promotional rebates, not income, and don't appear on T5 slips. If the user routes the bonus into a TFSA/FHSA, growth is tax-sheltered anyway.
...
**Headline:** It's the opposite. Wealthsimple becoming a bank is exactly why we need to capture investors *now*, while we still have the deposit relationship 80% of young Canadians can't easily move yet.
...
**Headline:** Three structural moats: pre-verified KYC, real-time internal transfers, and existing trust at the moment of low confidence. Wealthsimple has to acquire the customer first; we've already done that step.

**Backup detail:**
- KYC: Wealthsimple must do fresh FINTRAC identity verification on every new customer. We re-use ours via Method 5.
- Internal transfers: Wealthsimple Roundup pulls from external bank accounts weekly (1–3 day delay, NSF risk). We move money internally, instantly.
- Trust capital: 190 years vs Wealthsimple's 12. Different conversation with a 22-year-old's parents about where their money should sit.
- Even if Wealthsimple copies the $25 + matching mechanic perfectly, they pay it to acquire a new customer; we pay it to deepen an existing one. **Different unit economics.**
...
- ScotiaSeed differentiation: matched contributions + two-ledger UI + behavioral milestone unlocks + education gated to bonus + FHSA hero positioning.
- The case explicitly says (page 5) that fintechs win on "simplicity, cost, experience design." TD GoalAssist competes on Big Six brand only. We compete on both.

### Q14. "Why not just copy what Wealthsimple is doing? They're winning."

**Headline:** Two reasons: we have something Wealthsimple doesn't (an existing deposit relationship), and we have something fintechs structurally can't have (190 years of CDIC-backed trust). Copying their playbook loses our advantage.
...
- iTRADE: commission-free on 200+ ETFs (1 business day hold) but $25/quarter maintenance fee on registered accounts under balance threshold.
- Default: Essentials. Upgrade path to iTRADE once user wants self-directed agency or balance crosses the maintenance-fee waiver threshold.
- **Honesty card:** The MER on Essentials is a real cost. We disclose it on the celebration screen so users see "Balanced growth · 0.65% MER" at signup.

### Q16. "What happens if a user joins at 18, hits the 24-month graduation at 20, then what?"

**Headline:** Graduation = they roll into standard Scotia Smart Investor with no behavioral incentives but full account continuity. They keep all matched bonuses. Then they're eligible for upsell to iTRADE, advisory, eventually wealth management as their AUM grows.

**Backup detail:**
- Scotia's student account already auto-converts on Dec 1 of graduation year to a regular Preferred Package. ScotiaSeed mirrors this lifecycle.
- 24-month graduation is the moment we stop matching but start cross-selling FHSA contribution increase, RRSP setup at first salary, etc.
- The retention play after graduation is the FHSA → first home → mortgage attach loop.
...
- Investment accounts: existing TFSA/FHSA/RRSP via Smart Investor and Essentials Portfolios.
- PAC engine: already supports $25/month minimum.
- The new builds: (1) the two-ledger UI surface, (2) the matched-bonus ledger engine, (3) the forfeiture/restoration tracker, (4) the in-app education module surface, (5) the round-up routing logic. All ~6–12 month efforts at a Big Six engineering velocity.
- 18-month phased rollout: Q3'26 build → Q1'27 pilot → Q3'27 broaden → Q1'28 full launch.
...
- For users below the $25 PAC threshold, we lower it: $10/month minimum with longer milestone unlock timelines.
- The case's #1 stated barrier is *confidence*, but 61% of non-investors do still cite *lack of funds* (Exhibit A). The round-up engine attacks both.

### Q20. "What does ScotiaSeed look like if it works in 5 years?"

**Headline:** 500K young Canadians active in ScotiaSeed, $2–3B in incremental managed AUM for Scotiabank, the first cohort starting to attach FHSA → mortgage relationships, and Wealthsimple's youth acquisition rate visibly slowing in the segment.

**Backup detail:**
- 5-year target: 5% of the 1.25M target cohort = ~62K/year × 5 = 312K activated (after attrition ~500K accounts opened cumulatively).
- AUM contribution: assume $5K avg balance at year 3 × 500K accounts = $2.5B AUM.
- Scaling Scotia's existing Global Wealth Management AUM ($432B as of FY25 per case page 2) by even 0.5% from this cohort is meaningful.
- The strategic prize is the *next 30 years* of relationship value as FHSA → mortgage → RRSP → wealth advisory unfolds.

---

## ANTICIPATED CURVEBALLS

### "Why two years and not one or three?"

The fintech retention curve shows two cliffs: month 12 (where 40% drop off) and month 24 (where users who stay tend to stay for years). Our two-year program is calibrated to cross both cliffs. One year quits before the second cliff; three years stretches Scotia's exposure without proportional retention gain (Vanguard data on multi-year vesting shows diminishing returns past 3 years).
...
Two reasons. First, the data: bulk of FHSA contributors are 25–34, with the youngest cohort depositing $5,500/yr on average. Second, the emotional story: housing anxiety is the dominant financial fear for under-35s in Canada. The TFSA is abstract; the FHSA has a tangible "your first home" picture attached.
...
Acquisition advertising at the Big Six runs roughly $50–150 CPM and converts at sub-1% to account opening. ScotiaSeed paid only on action gives Scotia direct cost-per-converted-investor visibility and pays nothing for the no-shows. It's *performance marketing* applied to a deposits-to-investing funnel.

---

## ONE-LINERS YOU SHOULD MEMORIZE

For when you're cornered and need a confident reset:

1. **"The bonus is the hook. The auto-PAC is the moat. The two-ledger UI is the trust."**
2. **"We're not building a fintech inside a bank. We're using the bank we already are."**
3. **"Young Canadians are getting financial advice from TikTok. We can do better."**
4. **"$300 to convert a customer whose 20-year value is $3–6K. That's a 10-to-20x trade."**
5. **"Wealthsimple has to acquire the customer first. We've already done that step."**
...
## IF YOU HAVE 30 SECONDS LEFT AT THE END OF Q&A

> "The case asked how to convert young Canadians from deposit customers into long-term investors before fintechs capture them. ScotiaSeed answers that question with a 2-year matched path that runs through Scotia's existing rails, attacks the case's stated barriers of confidence and clarity, costs less per converted user than Scotia's existing student acquisition spend, and delivers 10x–20x ROI on the case's own wealth-transfer math. The first step is on us."
