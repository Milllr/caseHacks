> **Canonicity note.** This memo was written during the strategic-validation phase, before the final program structure was locked. Where this document conflicts with `TEAM_CONTEXT.md`, the TEAM_CONTEXT version is canonical. Specifically: the program duration is 24 months (not "3+ years"), and the bonus distribution is $25 instant + $25 education + $50 PAC + $100 at month 12 + $100 at month 24 (not "$25 yearly"). All other facts and citations in this memo remain accurate.
